...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      approval_workflows: {
        Row: {
          approved_at_level_1: string | null
          approved_at_level_2: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "approval_workflows_approved_by_level_1_fkey"
            columns: ["approved_by_level_1"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "approval_workflows_approved_by_level_2_fkey"
            columns: ["approved_by_level_2"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "approval_workflows_rejected_by_fkey"
            columns: ["rejected_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "approval_workflows_submitted_by_fkey"
...
export const Constants = {
  public: {
    Enums: {
      ...
      approval_status: ["draft", "submitted", "approved_level_1", "approved_level_2", "rejected", "released"],
    },
  },
} as const
